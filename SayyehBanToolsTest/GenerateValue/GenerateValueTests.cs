...
/// </summary>
public class GenerateValueTests
{
    ...
    public void Generate_Unique_Number_ReturnsEightDigitNumber()
    {
        ...
        string result = GenerateValue.Generate_Unique_Number();
    ...
    public void Generate_Unique_Number_GeneratesDifferentNumbers()
    {
        ...
        string result1 = GenerateValue.Generate_Unique_Number();
        string result2 = GenerateValue.Generate_Unique_Number();
    ...
    public void Generate16ValueRandome_ReturnsSixteenCharacterString()
    {
        ...
        string result = GenerateValue.Generate16ValueRandome();
    ...
    public void Generate16ValueRandome_GeneratesDifferentStrings()
    {
        ...
        string result1 = GenerateValue.Generate16ValueRandome();
        string result2 = GenerateValue.Generate16ValueRandome();
        Assert.NotEqual(result1, result2); // احتمال برابر بودن بسیار کم است
    }
}